...
export declare class RPCClient {
     ...
     */
    query(req: Record<string, unknown>, config?: AxiosRequestConfig): Promise<any>;
    /**
     ...
     */
    getBlock(indexOrHash: string | number, verbose?: number): Promise<Record<string, unknown> | string>;
    /**
     ...
     */
    getContractState(scriptHash: string): Promise<Record<string, unknown>>;
    /**
