...
export declare class ContractParam {
     ...
     */
    static byteArray(value: string | number | Fixed8, format: string, ...args: any[]): ContractParam;
    /**
    ...
    value: any;
    constructor(type: ContractParam | ContractParamLike | ContractParamType | keyof typeof ContractParamType | number, value?: unknown);
    get [Symbol.toStringTag](): string;
    export(): ContractParamLike;
    equal(other: ContractParamLike): boolean;
}
export default ContractParam;
export declare function likeContractParam(cp: Partial<ContractParam | ContractParamLike>): cp is ContractParamLike;
